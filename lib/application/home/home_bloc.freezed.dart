...
mixin _$HomeState {
  ...
  List<Result> get trendingMovieList => throw _privateConstructorUsedError;
  List<Result> get tenseDramasList => throw _privateConstructorUsedError;
...
abstract class $HomeStateCopyWith<$Res> {
  ...
  $Res call(
      ...
      List<Result> trendingMovieList,
      List<Result> tenseDramasList,
...
class _$InitialImpl implements _Initial {
  const _$InitialImpl(
      ...
      required final List<Result> trendingMovieList,
      required final List<Result> tenseDramasList,
  ...
  final List<Result> _trendingMovieList;
  @override
  List<Result> get trendingMovieList {
  ...
  final List<Result> _tenseDramasList;
  @override
  List<Result> get tenseDramasList {
  ...
  @override
  String toString() {
    return 'HomeState(stateId: $stateId, pastYearMovieList: $pastYearMovieList, trendingMovieList: $trendingMovieList, tenseDramasList: $tenseDramasList, southIndianMovieList: $southIndianMovieList, trendingTvList: $trendingTvList, isLoading: $isLoading, isError: $isError)';
  }
